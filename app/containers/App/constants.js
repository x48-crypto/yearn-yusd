...
export const SELECTED_TOKEN_APPROVED = 'SELECTED_TOKEN_APPROVED';

export const DEPOSIT = 'DEPOSIT';
export const WITHDRAW = 'WITHDRAW';

export const RUN_CONFETTI_START = 'RUN_CONFETTI_START';
export const RUN_CONFETTI_STOP = 'RUN_CONFETTI_STOP';
